...
<div class="container">
	<h3 style='padding-top:20px;padding-bottom:5px'>Добавление курса</h3>
	...
	<form action='manager_profile.php' method='POST' class='form-group'>
		<div class="row">
			<div class="col">
				...
				<input type='text' id='input-name' name='program_name' class='form-control'>
				...
				<select id="normal-select-1" name='program_category' placeholder-text="" value="">
					<nobr>
				...
				<div id="course-data">
					...
					<div id="selectors" style="display:none">
						...
						<select id="normal-select-2" name='program_type' placeholder-text="" value="">
						...
						<select id="normal-select-3" name='program_doc' placeholder-text="" value="">
						...
						<select id="normal-select-4" name='certification_type' placeholder-text="" value="">
			...
			<div class="col">
				...
				<div id="preview-icon" style="display:none;">
					<input type="text" id="input-icon" name="icon" class="form-control">
					<p id="new-icon" class="btn-submit">Применить</p>
				</div>
				<i class="fa-solid fa-circle-question fa-8x" id="add-icon" style="color:rgb(170, 113, 245);background-color:white;padding:15px;border-radius:3px;cursor: pointer;"></i>
				...
				<div class="row">
					<div class="col">
						...
						<input type='number' id='input-price' name='price' class='form-control'>
					</div>
					<div class="col">
						<p class="bold-text">Количество часов</p>
						<input type='number' id='input-hours' name='hours' class='form-control'>
					</div>
				</div>
				<div class="btn-div" style="padding-top:90px">
					<button class="btn-submit" type="submit" name="save-data">Добавить</button>
...
<script>
	...
	$(document).on('click', '#new-icon', function() {
		$("#preview-icon").hide();
		$("#add-icon").show();
		$("#add-icon").removeClass();
		if ($("#input-icon").val() !== "") {
			$("#add-icon").addClass($("#input-icon").val() + " fa-8x");

		} else {
			$("#add-icon").addClass("fa-solid fa-circle-question fa-8x");
		}
	})
